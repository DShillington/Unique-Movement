...
public class EntitySwegwayYellow extends EntityAnimal
{
    ...
    public EntitySwegwayYellow(World par1World)
    {
    	 super(par1World);
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(UniqueMovementMod.SwegwaySpeed);
    }
   ...
   /**
	...
	public double getMaxVelocity() {
		...
		return UniqueMovementMod.SwegwaySpeed;
	}
