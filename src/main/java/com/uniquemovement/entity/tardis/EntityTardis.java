...
public class EntityTardis extends EntityAnimal
{
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(UniqueMovementMod.TardisSpeed);
    }
   ...
   /**
    ...
    {
        return (double)this.height - 2.4D;
    }
	...
	public double getMaxVelocity() {
		...
		return UniqueMovementMod.TardisSpeed;
	}
