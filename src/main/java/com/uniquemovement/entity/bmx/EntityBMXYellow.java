...
public class EntityBMXYellow extends EntityAnimal
{
    ...
    public EntityBMXYellow(World par1World)
    {
    	 super(par1World);
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(UniqueMovementMod.BMXSpeed);
    }
   ...
   /**
	...
	public double getMaxVelocity() {
		...
		return UniqueMovementMod.BMXSpeed;
	}
