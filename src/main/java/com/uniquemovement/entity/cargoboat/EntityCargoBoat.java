...
public class EntityCargoBoat extends EntityAnimal
{
    ...
    public EntityCargoBoat(World par1World)
    {
    	 super(par1World);
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(UniqueMovementMod.CargoBoatSpeed);
    }
     ...
     */
    public boolean interact(EntityPlayer par1EntityPlayer, BlockPos pos)
    {
        if (super.interact(par1EntityPlayer))
        {
         if (par1EntityPlayer.isSneaking())
        	...
        	{
        		par1EntityPlayer.openGui(UniqueMovementMod.instance, UniqueMovementMod.CARGO_BOAT_GUI_ID, worldObj, pos.getX(), pos.getY(), pos.getZ());
   ...
   /**
	...
	public double getMaxVelocity() {
		...
		return UniqueMovementMod.CargoBoatSpeed;
	}
