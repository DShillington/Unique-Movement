...
public class EntityHovercraftOrange extends EntityAnimal
{
    ...
    public EntityHovercraftOrange(World par1World)
    {
    	 super(par1World);
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(UniqueMovementMod.HovercraftSpeed);
    }
   ...
   /**
	...
	public double getMaxVelocity() {
		...
		return UniqueMovementMod.HovercraftSpeed;
	}
