...
public class EntityAventadorOrange extends EntityAnimal
{
    ...
    public EntityAventadorOrange(World par1World)
    {
    	 super(par1World);
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(UniqueMovementMod.AventadorSpeed);
    }
   ...
   /**
	...
	public double getMaxVelocity() {
		...
		return UniqueMovementMod.AventadorSpeed;
	}
