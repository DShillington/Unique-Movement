...
public class EntitySegwayOrange extends EntityAnimal
{
    ...
    public EntitySegwayOrange(World par1World)
    {
    	 super(par1World);
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(UniqueMovementMod.SegwaySpeed);
    }
   ...
   /**
	...
	public double getMaxVelocity() {
		...
		return UniqueMovementMod.SegwaySpeed;
	}
