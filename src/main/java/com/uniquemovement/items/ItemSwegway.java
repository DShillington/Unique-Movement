...
public class ItemSwegway extends ItemBase{
	public ItemSwegway()
	{
		super();
	}
					 ...
					 if(par3EntityPlayer.getCurrentEquippedItem() != null)
				      {
				         ...
				         if(hand.getItem() == MovementItems.Swegway_blue){
				        	 EntitySwegwayBlue entity3 = new EntitySwegwayBlue(par2World);
				         ...
				         if(hand.getItem() == MovementItems.Swegway_green){
				        	 EntitySwegwayGreen entity3 = new EntitySwegwayGreen(par2World);
							 entity3.rotationYaw = (float)(((MathHelper.floor_double((double)(par3EntityPlayer.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3) - 1) * 90);
							 entity3.setPosition(blockPos.getX(), blockPos.getY() + 2, blockPos.getZ());
			                 if (!par2World.getCollidingBoundingBoxes(entity3, entity3.getEntityBoundingBox().expand(-0.1D, -0.1D, -0.1D)).isEmpty()){return par1ItemStack;}
			                 if (!par2World.isRemote){par2World.spawnEntityInWorld(entity3);}
				         ...
				         if(hand.getItem() == MovementItems.Swegway_orange){
				        	 EntitySwegwayOrange entity3 = new EntitySwegwayOrange(par2World);
							 entity3.rotationYaw = (float)(((MathHelper.floor_double((double)(par3EntityPlayer.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3) - 1) * 90);
							 entity3.setPosition(blockPos.getX(), blockPos.getY() + 2, blockPos.getZ());
			                 if (!par2World.getCollidingBoundingBoxes(entity3, entity3.getEntityBoundingBox().expand(-0.1D, -0.1D, -0.1D)).isEmpty()){return par1ItemStack;}
			                 if (!par2World.isRemote){par2World.spawnEntityInWorld(entity3);}
				         ...
				         if(hand.getItem() == MovementItems.Swegway_pink){
				        	 EntitySwegwayPink entity3 = new EntitySwegwayPink(par2World);
							 entity3.rotationYaw = (float)(((MathHelper.floor_double((double)(par3EntityPlayer.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3) - 1) * 90);
							 entity3.setPosition(blockPos.getX(), blockPos.getY() + 2, blockPos.getZ());
			                 if (!par2World.getCollidingBoundingBoxes(entity3, entity3.getEntityBoundingBox().expand(-0.1D, -0.1D, -0.1D)).isEmpty()){return par1ItemStack;}
			                 if (!par2World.isRemote){par2World.spawnEntityInWorld(entity3);}
				         ...
				         if(hand.getItem() == MovementItems.Swegway_purple){
				        	 EntitySwegwayPurple entity3 = new EntitySwegwayPurple(par2World);
							 entity3.rotationYaw = (float)(((MathHelper.floor_double((double)(par3EntityPlayer.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3) - 1) * 90);
							 entity3.setPosition(blockPos.getX(), blockPos.getY() + 2, blockPos.getZ());
			                 if (!par2World.getCollidingBoundingBoxes(entity3, entity3.getEntityBoundingBox().expand(-0.1D, -0.1D, -0.1D)).isEmpty()){return par1ItemStack;}
			                 if (!par2World.isRemote){par2World.spawnEntityInWorld(entity3);}
				         ...
				         if(hand.getItem() == MovementItems.Swegway_red){
				        	 EntitySwegwayRed entity3 = new EntitySwegwayRed(par2World);
							 entity3.rotationYaw = (float)(((MathHelper.floor_double((double)(par3EntityPlayer.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3) - 1) * 90);
							 entity3.setPosition(blockPos.getX(), blockPos.getY() + 2, blockPos.getZ());
			                 if (!par2World.getCollidingBoundingBoxes(entity3, entity3.getEntityBoundingBox().expand(-0.1D, -0.1D, -0.1D)).isEmpty()){return par1ItemStack;}
			                 if (!par2World.isRemote){par2World.spawnEntityInWorld(entity3);}
				         ...
				         if(hand.getItem() == MovementItems.Swegway_white){
				        	 EntitySwegwayWhite entity3 = new EntitySwegwayWhite(par2World);
							 entity3.rotationYaw = (float)(((MathHelper.floor_double((double)(par3EntityPlayer.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3) - 1) * 90);
							 entity3.setPosition(blockPos.getX(), blockPos.getY() + 2, blockPos.getZ());
			                 if (!par2World.getCollidingBoundingBoxes(entity3, entity3.getEntityBoundingBox().expand(-0.1D, -0.1D, -0.1D)).isEmpty()){return par1ItemStack;}
			                 if (!par2World.isRemote){par2World.spawnEntityInWorld(entity3);}
				         ...
				         if(hand.getItem() == MovementItems.Swegway_yellow){
				        	 EntitySwegwayYellow entity3 = new EntitySwegwayYellow(par2World);
							 entity3.rotationYaw = (float)(((MathHelper.floor_double((double)(par3EntityPlayer.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3) - 1) * 90);
							 entity3.setPosition(blockPos.getX(), blockPos.getY() + 2, blockPos.getZ());
			                 if (!par2World.getCollidingBoundingBoxes(entity3, entity3.getEntityBoundingBox().expand(-0.1D, -0.1D, -0.1D)).isEmpty()){return par1ItemStack;}
			                 if (!par2World.isRemote){par2World.spawnEntityInWorld(entity3);}
