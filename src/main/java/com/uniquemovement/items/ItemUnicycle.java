...
public class ItemUnicycle extends ItemBase{
	public ItemUnicycle()
	{
		super();
	}
					 ...
					 if(par3EntityPlayer.getCurrentEquippedItem() != null)
				      {
				         ...
				         if(hand.getItem() == MovementItems.Unicycle_blue){
				        	 EntityUnicycleBlue entity3 = new EntityUnicycleBlue(par2World);
				         ...
				         if(hand.getItem() == MovementItems.Unicycle_green){
				        	 EntityUnicycleGreen entity3 = new EntityUnicycleGreen(par2World);
							 entity3.rotationYaw = (float)(((MathHelper.floor_double((double)(par3EntityPlayer.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3) - 1) * 90);
							 entity3.setPosition(blockPos.getX(), blockPos.getY() + 2, blockPos.getZ());
			                 if (!par2World.getCollidingBoundingBoxes(entity3, entity3.getEntityBoundingBox().expand(-0.1D, -0.1D, -0.1D)).isEmpty()){return par1ItemStack;}
			                 if (!par2World.isRemote){par2World.spawnEntityInWorld(entity3);}
				         ...
				         if(hand.getItem() == MovementItems.Unicycle_orange){
				        	 EntityUnicycleOrange entity3 = new EntityUnicycleOrange(par2World);
							 entity3.rotationYaw = (float)(((MathHelper.floor_double((double)(par3EntityPlayer.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3) - 1) * 90);
							 entity3.setPosition(blockPos.getX(), blockPos.getY() + 2, blockPos.getZ());
			                 if (!par2World.getCollidingBoundingBoxes(entity3, entity3.getEntityBoundingBox().expand(-0.1D, -0.1D, -0.1D)).isEmpty()){return par1ItemStack;}
			                 if (!par2World.isRemote){par2World.spawnEntityInWorld(entity3);}
				         ...
				         if(hand.getItem() == MovementItems.Unicycle_pink){
				        	 EntityUnicyclePink entity3 = new EntityUnicyclePink(par2World);
							 entity3.rotationYaw = (float)(((MathHelper.floor_double((double)(par3EntityPlayer.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3) - 1) * 90);
							 entity3.setPosition(blockPos.getX(), blockPos.getY() + 2, blockPos.getZ());
			                 if (!par2World.getCollidingBoundingBoxes(entity3, entity3.getEntityBoundingBox().expand(-0.1D, -0.1D, -0.1D)).isEmpty()){return par1ItemStack;}
			                 if (!par2World.isRemote){par2World.spawnEntityInWorld(entity3);}
				         ...
				         if(hand.getItem() == MovementItems.Unicycle_purple){
				        	 EntityUnicyclePurple entity3 = new EntityUnicyclePurple(par2World);
							 entity3.rotationYaw = (float)(((MathHelper.floor_double((double)(par3EntityPlayer.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3) - 1) * 90);
							 entity3.setPosition(blockPos.getX(), blockPos.getY() + 2, blockPos.getZ());
			                 if (!par2World.getCollidingBoundingBoxes(entity3, entity3.getEntityBoundingBox().expand(-0.1D, -0.1D, -0.1D)).isEmpty()){return par1ItemStack;}
			                 if (!par2World.isRemote){par2World.spawnEntityInWorld(entity3);}
				         ...
				         if(hand.getItem() == MovementItems.Unicycle_red){
				        	 EntityUnicycleRed entity3 = new EntityUnicycleRed(par2World);
							 entity3.rotationYaw = (float)(((MathHelper.floor_double((double)(par3EntityPlayer.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3) - 1) * 90);
							 entity3.setPosition(blockPos.getX(), blockPos.getY() + 2, blockPos.getZ());
			                 if (!par2World.getCollidingBoundingBoxes(entity3, entity3.getEntityBoundingBox().expand(-0.1D, -0.1D, -0.1D)).isEmpty()){return par1ItemStack;}
			                 if (!par2World.isRemote){par2World.spawnEntityInWorld(entity3);}
				         ...
				         if(hand.getItem() == MovementItems.Unicycle_white){
				        	 EntityUnicycleWhite entity3 = new EntityUnicycleWhite(par2World);
							 entity3.rotationYaw = (float)(((MathHelper.floor_double((double)(par3EntityPlayer.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3) - 1) * 90);
							 entity3.setPosition(blockPos.getX(), blockPos.getY() + 2, blockPos.getZ());
			                 if (!par2World.getCollidingBoundingBoxes(entity3, entity3.getEntityBoundingBox().expand(-0.1D, -0.1D, -0.1D)).isEmpty()){return par1ItemStack;}
			                 if (!par2World.isRemote){par2World.spawnEntityInWorld(entity3);}
				         ...
				         if(hand.getItem() == MovementItems.Unicycle_yellow){
				        	 EntityUnicycleYellow entity3 = new EntityUnicycleYellow(par2World);
							 entity3.rotationYaw = (float)(((MathHelper.floor_double((double)(par3EntityPlayer.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3) - 1) * 90);
							 entity3.setPosition(blockPos.getX(), blockPos.getY() + 2, blockPos.getZ());
			                 if (!par2World.getCollidingBoundingBoxes(entity3, entity3.getEntityBoundingBox().expand(-0.1D, -0.1D, -0.1D)).isEmpty()){return par1ItemStack;}
			                 if (!par2World.isRemote){par2World.spawnEntityInWorld(entity3);}
